...
public class FlightCrewMemberAssignmentFlightPublishService extends AbstractGuiService<FlightCrewMember, FlightAssignment> {
	...
	public void validate(final FlightAssignment object) {
		...
		boolean momentIsNull = object.getLastUpdate() != null;
		super.state(momentIsNull, "lastUpdate", "acme.validation.flightAssignment.flightCrewMember.momentNull");

		if (object.getLeg() != null && object.getLastUpdate() != null) {
